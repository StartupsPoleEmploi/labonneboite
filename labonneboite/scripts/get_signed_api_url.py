...
def add_signature_to_query(api_user: str, api_key: str, query: ParseQuery) -> ParseQuery:
    ...
    # E.g.:
    # 'latitude=48.866667&longitude=2.333333&rome_codes=A1501&timestamp=2017-05-11T10%3A06%3A20&user=YOUR_API_USER'
...
@click.option('--api-key', help="Might be env var LBB_API_KEY (if unset the key will be ask)", prompt=True, hide_input=True)  # noqa
@click.argument('url')
