...
class PerfPredictionAndEffectiveHirings(CRUDMixin, Base):
    ...
    lbb_nb_predicted_hirings = Column(Integer) #Score associé au Nombre de recrutement prédits pour LBB (en utilisant les DPAE)
    lba_nb_predicted_hirings = Column(Integer) #Score associé au Nombre de recrutements prédits pour LBA (en utilisant APR et CP)
