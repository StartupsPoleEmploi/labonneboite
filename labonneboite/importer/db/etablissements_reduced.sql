# should stay identical to etablissements.sql except for the table name
# table used on development only to avoid overwriting development etablissements table

DROP TABLE if exists etablissements_reduced;

CREATE TABLE etablissements_reduced (
  siret varchar(191),
