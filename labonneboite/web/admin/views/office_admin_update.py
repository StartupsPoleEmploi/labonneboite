...
class OfficeAdminUpdateModelView(AdminModelViewMixin, ModelView):
    ...
    column_labels = {
        ...
        'new_score': u'Modifier le score LBB',
        'new_score_alternance': u'Modifier le score LBA',
    ...
    column_descriptions = {
        ...
        'new_score': u"Nouveau score (si 0 : suppression de l'entreprise sur LBB : API et Front - mais l'API LBA !)",
        'new_score_aternance': u"Nouveau score alternance (si 0 : suppression de l'entreprise pour l'alternance)",
