...
class SearchIsochroneTests(unittest.TestCase):
    ...
    def test_isochrone(self):
        ...
        should_filters = body["query"]["function_score"]["query"]["function_score"]["query"]["filtered"]["filter"][
            "bool"
        ]["should"]
    ...
    def test_isochrone_with_broken_backend(self):
        ...
        self.assertNotIn(
            "should", body["query"]["function_score"]["query"]["function_score"]["query"]["filtered"]["filter"]["bool"]
        )
