...
class SafeUrlTest(unittest.TestCase):
    ...
    def test_is_safe_url(self):
        ...
        url = u'http://localhost:8090/entreprises/metz-57000/boucherie?sort=score&d=10&h=1&p=0'
        ...
        url = u'http://labonneboite.pole-emploi.fr/entreprises/metz-57000/boucherie?sort=score&d=10&h=1&p=0'
        is_safe_url = util.is_safe_url(url, allowed_hosts={'labonneboite.pole-emploi.fr'})
        self.assertTrue(is_safe_url)
