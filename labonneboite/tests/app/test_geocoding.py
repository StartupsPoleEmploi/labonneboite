...
class GeocodingTest(TestCase):
    ...
    def test_montigny_les_metz_is_correctly_found(self):
        ...
        montigny_zipcodes = [
            x[1] for x in cities_zipcodes if x[0].startswith("Montigny-l") and x[0].endswith("s-Metz")
        ]
...
class AdresseApiTest(TestCase):
    ...
    def test_get_address(self):
        ...
        self.assertEqual(
            [{"city": "Paris", "zipcode": "75019", "label": "22 Allée Darius Milhaud 75019 Paris"}], address
        )
