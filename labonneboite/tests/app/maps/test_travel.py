...
class mock_backend(object):
    ...
    def durations(origin, destinations):
        distances = {(places.vallouise, places.paris): 7000, (places.vallouise, places.metz): 5000}
...
class BackendCacheFuncTests(unittest.TestCase):
    def test_cache_key(self):
        self.assertEqual(
            b'["funcname", "travelmode", "arg1", "arg2"]', travel.cache_key("funcname", "travelmode", "arg1", "arg2")
        )
