...
class TestPerfInsertData(DatabaseTest):
    ...
    def test_get_available_files_list(self):
        ...
        self.assertTrue("export_etablissement_backup_2020_11_10_1716.sql.gz" in files_list[0])
    ...
    def test_insert_data_from_file(self):
        ...
        self.assertTrue(
            PerfImporterCycleInfos.query.filter(
                PerfImporterCycleInfos.file_name=="export_etablissement_backup_2020_11_10_1716.sql.gz").count() == 1)
