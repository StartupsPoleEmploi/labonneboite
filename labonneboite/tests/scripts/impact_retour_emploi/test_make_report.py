...
class TestMakeReport(unittest.TestCase):
    ...
    def test_prepare_google_sheet_data(self):
        ...
        data = [[6, "12-2018"]]
        self.pdfgsr.df_evol_idpe_connect_sign_afficher_details = pd.DataFrame(
            data, columns=['count_distinct_activity_afficher_details', 'date_month'])

        data = [[6, "12-2018"]]
        self.pdfgsr.df_evol_idpe_connect_sign_details = pd.DataFrame(
            data, columns=['count_distinct_activity_details', 'date_month'])
        ...
        self.pdfgsr.df_nb_candidatures_jp = pd.read_csv(
            f'{self.pdfgsr.csv_jp_folder_path}/dump_nb_candidatures_jp.csv', delimiter=';')
        self.pdfgsr.df_nb_distinct_email_jp = pd.read_csv(
            f'{self.pdfgsr.csv_jp_folder_path}/dump_nb_distinct_email_jp.csv', delimiter=';')
        self.pdfgsr.df_nb_candidates_with_answer_jp = pd.read_csv(
            f'{self.pdfgsr.csv_jp_folder_path}/dump_nb_candidates_with_answer_jp.csv', delimiter=';')
        self.pdfgsr.df_medium_delay_answer_jp = pd.read_csv(
            f'{self.pdfgsr.csv_jp_folder_path}/dump_medium_delay_answer_jp.csv', delimiter=';')
        ...
        years_good_format_sorted = ['2018-11', '2018-12', '2019-01', '2019-02', '2019-03', '2019-04', '2019-05',
    ...
    def test_prepare_2nd_google_sheet_data(self):
        ...
        self.pdfgsr.df_evol_nb_dpae_hiring_and_activity_date = pd.DataFrame(
            data, columns=['count_dpae_lbb', 'date_month_activite', 'date_month_embauche'])
