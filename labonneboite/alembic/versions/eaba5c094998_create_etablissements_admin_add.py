...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('website', mysql.VARCHAR(collation=u'utf8mb4_unicode_ci', length=191), nullable=False),
        ...
        sa.ForeignKeyConstraint(['created_by_id'], [u'users.id'], name=u'etablissements_admin_add_ibfk_1',
            ondelete=u'SET NULL'),
