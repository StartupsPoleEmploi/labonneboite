...
def upgrade():
    ...
    op.add_column('users', sa.Column('is_admin', mysql.TINYINT(display_width=1), server_default=sa.text(u"'0'"),
    ...
    op.create_table(
        ...
        sa.Column('name', mysql.VARCHAR(collation=u'utf8mb4_unicode_ci', length=191), nullable=False),
        sa.Column('reason', mysql.TEXT(collation=u'utf8mb4_unicode_ci'), nullable=False),
        sa.Column('initiative', mysql.VARCHAR(collation=u'utf8mb4_unicode_ci', length=191), nullable=False),
        sa.Column('date_follow_up_phone_call', mysql.DATETIME(), nullable=True),
        sa.Column('requested_by_email', mysql.VARCHAR(collation=u'utf8mb4_unicode_ci', length=191), nullable=False),
        sa.Column('requested_by_first_name', mysql.VARCHAR(collation=u'utf8mb4_unicode_ci', length=191),
            nullable=False),
        sa.Column('requested_by_last_name', mysql.VARCHAR(collation=u'utf8mb4_unicode_ci', length=191), nullable=False),
        sa.Column('requested_by_phone', mysql.VARCHAR(collation=u'utf8mb4_unicode_ci', length=191), nullable=False),
        ...
        sa.ForeignKeyConstraint(['created_by_id'], [u'users.id'], name=u'etablissements_admin_remove_ibfk_1',
            ondelete=u'SET NULL'),
        sa.ForeignKeyConstraint(['updated_by_id'], [u'users.id'], name=u'etablissements_admin_remove_ibfk_2',
            ondelete=u'SET NULL'),
    ...
    op.create_table(
        ...
        sa.Column('new_email', mysql.VARCHAR(collation=u'utf8mb4_unicode_ci', length=191), nullable=False),
        sa.Column('new_phone', mysql.VARCHAR(collation=u'utf8mb4_unicode_ci', length=191), nullable=False),
        sa.Column('new_website', mysql.VARCHAR(collation=u'utf8mb4_unicode_ci', length=191), nullable=False),
        ...
        sa.Column('created_by_id', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
        sa.Column('updated_by_id', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
        sa.ForeignKeyConstraint(['created_by_id'], [u'users.id'], name=u'etablissements_admin_update_ibfk_1',
            ondelete=u'SET NULL'),
        sa.ForeignKeyConstraint(['updated_by_id'], [u'users.id'], name=u'etablissements_admin_update_ibfk_2',
            ondelete=u'SET NULL'),
        sa.PrimaryKeyConstraint('id'),
        mysql_collate=u'utf8mb4_unicode_ci',
        mysql_default_charset=u'utf8mb4',
