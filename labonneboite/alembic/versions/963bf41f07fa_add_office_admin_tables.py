...
def upgrade():
    ...
    op.add_column('users', sa.Column('is_admin', mysql.TINYINT(display_width=1), server_default=sa.text("'0'"),
    ...
    op.create_table(
        ...
        sa.Column('requested_by_first_name', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=191),
            nullable=False),
        ...
        sa.ForeignKeyConstraint(['created_by_id'], ['users.id'], name='etablissements_admin_remove_ibfk_1',
            ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['updated_by_id'], ['users.id'], name='etablissements_admin_remove_ibfk_2',
            ondelete='SET NULL'),
    ...
    op.create_table(
        ...
        sa.Column('created_by_id', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
        sa.Column('updated_by_id', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
        sa.ForeignKeyConstraint(['created_by_id'], ['users.id'], name='etablissements_admin_update_ibfk_1',
            ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['updated_by_id'], ['users.id'], name='etablissements_admin_update_ibfk_2',
            ondelete='SET NULL'),
        sa.PrimaryKeyConstraint('id'),
        mysql_collate='utf8mb4_unicode_ci',
        mysql_default_charset='utf8mb4',
