...
def upgrade():
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by_id"], ["users.id"], name="etablissements_admin_extra_geolocations_ibfk_1", ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["updated_by_id"], ["users.id"], name="etablissements_admin_extra_geolocations_ibfk_2", ondelete="SET NULL"
        ),
