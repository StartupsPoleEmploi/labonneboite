...
def upgrade():
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['created_by_id'], [u'users.id'],
            name=u'etablissements_admin_extra_geolocations_ibfk_1', ondelete=u'SET NULL'),
        sa.ForeignKeyConstraint(['updated_by_id'], [u'users.id'],
            name=u'etablissements_admin_extra_geolocations_ibfk_2', ondelete=u'SET NULL'),
