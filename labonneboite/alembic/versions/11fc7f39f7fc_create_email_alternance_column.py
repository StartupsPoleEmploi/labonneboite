...
def upgrade():
    ...
    op.add_column(
        "etablissements_raw", sa.Column("email_alternance", mysql.TEXT(collation="utf8mb4_unicode_ci"), nullable=False)
    )
    op.add_column(
        "etablissements", sa.Column("email_alternance", mysql.TEXT(collation="utf8mb4_unicode_ci"), nullable=False)
    )
