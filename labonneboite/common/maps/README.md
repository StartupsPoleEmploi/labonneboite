...
1. Use this data with Elastic Search to filter enterprises located into polygons.
1. Display filtered results to the user.
1. Show commuting time for each enterprise in JS.
...
:information_source: Durations are retrieved 5 by 5 to avoid timeouts from upstream servers.
