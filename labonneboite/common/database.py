...
from labonneboite.common.env import ENV_DEVELOPMENT, ENV_TEST, get_current_env
...
ENGINE_PARAMS = {"convert_unicode": True, "echo": False, "pool_recycle": 30}
...
SESSIONMAKER_PARAMS = {"autocommit": False, "autoflush": False, "bind": engine}
