...
API_KEYS = {"labonneboite": "dummykey", "emploi_store_dev": "anotherdummykey"}
...
TRAVEL_VENDOR_BACKENDS = {
    ...
    "durations": {"car": "ign_mock", "public": "navitia_mock"},
}

PROCESS_ASYNC_TASKS = False

# Dummy IP addresses for test only
VERSION_PRO_ALLOWED_IPS = ["198.49.0.0/30", "198.49.23.144"]
