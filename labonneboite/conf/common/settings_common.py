...
from labonneboite.common.load_data import load_naf_labels, load_rome_labels
...
HEADCOUNT_VALUES = {"all": HEADCOUNT_WHATEVER, "big": HEADCOUNT_BIG_ONLY, "small": HEADCOUNT_SMALL_ONLY}
...
TRAVEL_VENDOR_BACKENDS = {
    "isochrone": {"car": "ign", "public": "navitia"},
    "durations": {"car": "ign", "public": "navitia"},
}
...
IGN_CREDENTIALS = {"key": "", "username": "", "password": ""}
